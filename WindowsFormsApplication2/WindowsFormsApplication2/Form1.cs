...
namespace WindowsFormsApplication2
{
    public partial class Form1 : Form
    {
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            ...
            if (this.radioButton1.Checked)         //Obtain TCP connect options
                str = this.txt_tcp.Text;
            ...
            if (IntPtr.Zero == h)
            {
                ...
                {
                    ret = PullLastError();
                    MessageBox.Show("No se pudo conectar, vuelva a intentarlo");
        ...
        private void txt_tcp_TextChanged(object sender, EventArgs e)
        {
...
//            string str = this.txtdev1.Text;
            ...
            if (ret >= 0)
            {
                this.txtgetdata10.Text = Encoding.Default.GetString(buffer);
                strcount = Encoding.Default.GetString(buffer);
                MessageBox.Show("Leer " + ret + " registros");
            }
            else
            {
...
//4.4 call GetDeviceParam function
        ...
        private int SetDeviceData(IntPtr h, object devtablename, string data, string options)
        {
...
public string devtablename = "";
        private void cmbdevtable_DropDownClosed(object sender, EventArgs e)
        {
            ...
            {
                this.textBox11.Text = "CardNo\tPin\tPassword\tGroup\tStartTime\tEndTime";
            ...
            {
                this.txtdev1.Text = "Pin\tAuthorizeTimezoneId\tAuthorizeDoorId";
            ...
            {
                this.txtdev1.Text = "Holiday\tHolidayType\tLoop";
            ...
            {
                this.txtdev1.Text = "Cardno\tPin\tVerified\tDoorID\tEventType\tInOutState\tTime_second";
            ...
            {
                this.txtdev1.Text = "Pin\tDoorID\tTimezoneID";
            ...
            {
                this.txtdev1.Text = "Index\tDoorId\tGroup1\tGroup2\tGroup3\tGroup4\tGroup5";
            ...
            {
                this.txtdev1.Text = "Index\tEventType\tInAddr\tOutType\tOutAddr\tOutTime\tReserved";
            ...
            {
                this.txtdev1.Text = "Size\tUID\tPin\tFingerID\tValid\tTemplate\tResverd\tEndTag";
 ...
 private int DeleteDeviceData10(IntPtr h, string tablename, string data, string options)
 {
     throw new NotImplementedException();
 }

 public string devdatfilter { get; set; }
 ...
 private void grabar_2_Click_1(object sender, EventArgs e)
...

 {
     ...
     string data = this.textBox12.Text;
            string options = "";
            if (data == "")
                this.textBox12.Text = "\r\n \t Introduzca aquí los datos seleccionados!";
            ...
            ret = SetDeviceData(h, devtablename, data, options);
     ...
     
                    {
                        ...
                        MessageBox.Show("La operación falló!");
 ...
 private void borrar_Click(object sender, EventArgs e)
 {
     int ret = 0;
     string devtablename = "user";
     string data = this.textBox11.Text;
     string options = "";
     if (data == "")
     ...
     this.textBox11.Clear();
     {
         ...
         if (IntPtr.Zero != h)
         {
             ...
             {
                 MessageBox.Show("La operación falló! Intente nuevamente " + ret);
             }
         }
         else
             MessageBox.Show("Por favor, conecte el dispositivo");
     }
 }


 private void texdev1_TextChanged(object sender, EventArgs e)
 {
...
public string sql = "server=127.0.0.1; database=riocuarto; User id=root; password=210506pyp;";
...
private void button22_Click(object sender, EventArgs e)
 {
     try
     {
         ...
         Conexion.Open();
         Query.CommandText = "SELECT nro_au11, reg_au11 FROM lpb_au11 ";
          ...
          
         {
           ...
           this.textBox11.Text +="CardNo=" + consultar["nro_au11"];
           this.textBox11.Text += "	Pin=" + consultar["reg_au11"] + Environment.NewLine;
...
private void radioButton2_CheckedChanged(object sender, EventArgs e)
    ...
    {
        txt_tcp.Text = "protocol=TCP,ipaddress=cocheraroma2.dyndns.org,port=4370,timeout=2000,passwd=";
        txt_tcp.Select(6, 5);
        MessageBox.Show("Cochera Ituzaingo");
    }
...
{
    this.button24.BackColor = Color.Cyan;
    this.button25.BackColor = BackColor;
}

private void button25_Click(object sender, EventArgs e)
{
    txt_tcp.Text = "protocol=TCP,ipaddress=192.168.1.221,port=4370,timeout=2000,passwd=";
    txt_tcp.Select(6, 5);
...
{
    this.button25.BackColor = Color.Cyan;
    this.button24.BackColor = BackColor;
}
